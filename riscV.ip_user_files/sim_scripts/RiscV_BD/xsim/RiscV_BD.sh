...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xpm -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip --snapshot RiscV_BD xil_defaultlib.RiscV_BD xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim RiscV_BD -key {Behavioral:sim_1:Functional:RiscV_BD} -tclbatch cmd.tcl -log simulate.log
}
